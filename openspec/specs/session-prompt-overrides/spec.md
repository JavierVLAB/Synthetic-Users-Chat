# session-prompt-overrides Specification

## Purpose
Sistema de overrides de secciones del system prompt por sesión. Permite al investigador editar el texto resuelto de perfil, brief y departamento en vivo, aplicando los cambios en los turnos siguientes sin modificar los archivos fuente ni persistir en la base de datos.
